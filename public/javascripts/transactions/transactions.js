...
function Transaction(item, parentViewModel) {
    ...
    self.personName = ko.computed(function () { return getName(parentViewModel.people(), item.person); });
    self.accountName = ko.computed(function () { return getName(parentViewModel.accounts(), item.account); });
...
vm = new AppViewModel(processTransactions);
